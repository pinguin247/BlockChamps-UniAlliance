...
import HardCentureSum from '../components/hardgesture';
import { Ionicons } from '@expo/vector-icons';

function HardGameScreen({navigation}){
    ...
    return (
      <View style={styles.container}>
        ...
        <>
        <View width="100%" style={{justifyContent:"space-between",marginTop:"auto", flexDirection:"row", padding:20}}>
        <TouchableOpacity style={{color:"white"}} onPress={Back}>
          ...
          <View style={{flex:1, flexDirection:"column", alignContent:"center"}}>
            <Text style={styles.modaltitle}>How to Play Hard Difficulty</Text>
